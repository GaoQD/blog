...
<body
	style="background-image: url(./img/demo-1-bg.jpg);>
	...
	<div class="container" id="main">
		...
		<div id="article">
			...
			<div id="a_head ">
				<h2>${article.title}</h3>
					...
					<div class="r_div" style="color:#00FFFF">
						<h3>
		...
		<div>
			...
			<div>
				...
				<button id="love"
					class="button-royal button-3d button-box button-jumbo"
		...
		<div class="comment">
			...
			<div class="r_div">
				<a href="#comment"
					class="button button-glow button-rounded button-royal button-small"><h4>
					...
					<div class="row">
						<div class="f_div">
							<img src="/Blog/img/comment.jpg" height="50" width="50"
								class="img-circle" /> &nbsp;&nbsp; <span style="color: #428bca">${comm.nickname}</span>
							<span style="color: #428bca">&nbsp;&nbsp;${comm.time}</span>
						</div>
						<div id="c_content" class="c_left">
							<h3>


								<div style="color:#fff">${comm.content }</div>
